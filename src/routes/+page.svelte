...
<main class="ml-64 p-8 max-w-4xl mx-auto flex-grow">
	...
	<section id="objectives" class="mb-12">
		<h2 class="text-2xl font-bold mb-4 text-blue-700">🎯 Learning Objectives</h2>
		<ul class="list-disc list-inside space-y-2 ml-4 bg-white p-6 rounded-lg shadow">
			...
			<li>Add electronic components (such as LED, resistor, button) to a simulation project using Wokwi’s component library.</li>
	...
	<section id="introduction" class="mb-12">
		...
		<img src="/src/assets/images/Pasted_image_20250919141508.png" alt="Wokwi homepage" class="my-4 border rounded-lg shadow-md w-full" />
		<p>
	...
	<section id="sign-in" class="mb-12">
		...
		<p>
			...
			To access all Wokwi features, signing in is essential. You can use Google, GitHub, or email — with Google being the easiest option.
		</p>
		<img src="/src/assets/images/Pasted_image_20250919141933.png" alt="Login options on Wokwi" class="my-4 border rounded-lg shadow w-full" />
		<p>
			After logging in, the "Sign In" button will be replaced by your profile icon. Click it to access features like <strong>My Projects</strong> — where you save and manage your projects.
		</p>
		<img src="/src/assets/images/Pasted_image_20250920060340.png" alt="Profile menu after login" class="my-4 border rounded-lg shadow w-full" />
	</section>
	...
	<section id="esp32-template" class="mb-12">
		...
		<p>
			Navigate to the ESP32 section. Here, you’ll find four sub-sections: <em>Featured Projects</em>, <em>Starter Template</em>, <em>ESP-IDF Template</em>, and <em>Latest Projects</em>. 
		...
		<img src="/src/assets/images/Pasted_image_20250920060711.png" alt="Starter Template selection" class="my-4 border rounded-lg shadow w-full" />
		<p>
			There are many boards in the starter template, but we’ll focus only on the standard ESP32.
		</p>
		<img src="/src/assets/images/Pasted_image_20250920060914.png" alt="ESP32 Starter Template" class="my-4 border rounded-lg shadow w-full" />
		...
		<img src="/src/assets/images/Pasted_image_20250920074303.png" alt="Arduino code structure in Wokwi" class="my-4 border rounded-lg shadow w-full" />
	</section>
	...
	<section id="initial-page" class="mb-12">
		...
		<img src="/src/assets/images/Pasted_image_20250920074303.png" alt="Initial editor view" class="my-4 border rounded-lg shadow w-full" />
	</section>
	...
	<section id="add-components" class="mb-12">
		...
		<img src="/src/assets/images/Pasted_image_20250922091138.png" alt="Add component button" class="my-4 border rounded-lg shadow w-full" />
		<p>
			Since the library contains many sensors and displays, finding specific components can be overwhelming. 
			Wokwi provides a <strong>search feature</strong> — simply type the component name in the search bar.
		</p>
		<img src="/src/assets/images/Pasted_image_20250922091800.png" alt="Component search feature" class="my-4 border rounded-lg shadow w-full" />
	</section>
	...
	<section id="connect-components" class="mb-12">
		...
		<p>
			Connecting components in Wokwi is simple — just click on the glowing connection points. 
		...
		<img src="/src/assets/images/Pasted_image_20250922104850.png" alt="LED connected to ESP32" class="my-4 border rounded-lg shadow w-full" />
	...
	<section id="coding" class="mb-12">
		...
		<p>
			Since this project only lights up one LED using the ESP32, we’ll replace the default code with a simpler version:
		</p>
...
void loop() {
  delay(10);
		...
		<img src="/src/assets/images/Pasted_image_20250922111718.png" alt="Code in Wokwi editor" class="my-4 border rounded-lg shadow w-full" />
	</section>
	...
	<section id="run-simulation" class="mb-12">
		...
		<img src="/src/assets/images/Pasted_image_20250922091138.png" alt="Play button in Wokwi" class="my-4 border rounded-lg shadow w-full" />
		<Note type="warning">
